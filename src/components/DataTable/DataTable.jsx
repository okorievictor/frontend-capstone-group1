...
const DataTable = () => {
  return (
    <section className="data-table-section" data-reveal>
          ...
          <table className="data-table">
            <thead>
              <tr>
                ...
                <th className="real-th">Mass (10<sup>24</sup>kg)</th>
                <th className="real-th">Diameter (km)</th>
                <th className="real-th">Density (kg/m<sup>3</sup>)</th>
                <th className="real-th">Gravity (m/s<sup>2</sup>)</th>
              </tr>
            </thead>
            <tbody>
